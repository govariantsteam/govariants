...
const Shift2 = new Vector2D(-0.8660254, 0.5);
const Shift3 = new Vector2D(-0.8660254, 1.5);
const Shift4 = new Vector2D(0, 2);
const Shift5 = new Vector2D(0.8660254, 1.5);
const Shift6 = new Vector2D(0.8660254, 0.5);

//shift from reference point to outer intersections
const Shift7 = new Vector2D(-0.5, -0.8660254);
const Shift8 = new Vector2D(-1.3660254, -0.3660254);
const Shift9 = new Vector2D(-1.8660254, 0.5);
const Shift10 = new Vector2D(-1.8660254, 1.5);
const Shift11 = new Vector2D(-1.3660254, 2.3660254);
const Shift12 = new Vector2D(-0.5, 2.8660254);
const Shift13 = new Vector2D(0.5, 2.8660254);
const Shift14 = new Vector2D(1.3660254, 2.3660254);
const Shift15 = new Vector2D(1.8660254, 1.5);
const Shift16 = new Vector2D(1.8660254, 0.5);
const Shift17 = new Vector2D(1.3660254, -0.3660254);
const Shift18 = new Vector2D(0.5, -0.8660254);

class PolygonalTile {
  ReferencePoint: Vector2D;
  Completed = false;
  Intersections: Intersection[];
  NeighbourTiles: (PolygonalTile | null)[] = [
    null,
    null,
    null,
    null,
  ...
  constructor(v: Vector2D) {
    ...
    this.Intersections = [
      new Intersection(v),
      new Intersection(v.Add(Shift2)),
      new Intersection(v.Add(Shift3)),
      new Intersection(v.Add(Shift4)),
      new Intersection(v.Add(Shift5)),
  ...
  for (let i = 1; i <= (size - 1) / 2; i++) {
    ...
    while (tileQueue.length > 0) {
      ...
      if (tile.NeighbourTiles[0] == null) {
        const newTile = new PolygonalTile(
