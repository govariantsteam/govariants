<template>
	...
	<p>
		Fractional is a multiplayer variant for any even number of participants. Players are grouped into two competing teams:
		<ul>
			<li><strong>Team Black</strong></li>
			<li><strong>Team White</strong></li>
		</ul>
		Each team receives points for the area of their <strong>Team Colour</strong>.
	</p>
	...
	<p>
		...
		<ul>
			<li><strong>New Chains</strong> are those including a stone placed this round.</li>
			<li><strong>Old Chains</strong> are those that don’t include a stone placed this round.</li>
		</ul>
