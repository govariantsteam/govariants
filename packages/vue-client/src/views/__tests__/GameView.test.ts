...
describe("GameView - Auto-seating", () => {
  ...
  it("should NOT auto-select when user occupies multiple seats", async () => {
    const currentUser: User = {
      id: "user123",
      username: "testuser",
    };

    const players: User[] = [currentUser, currentUser];
    ...
    const seatComponents = wrapper.findAllComponents({ name: "SeatComponent" });
    expect(seatComponents[0].props("selected")).toBeUndefined();
    expect(seatComponents[1].props("selected")).toBeUndefined();
  });

  it("should NOT auto-select when user occupies no seats", async () => {
    const currentUser: User = {
      id: "user123",
      username: "testuser",
    };
    ...
    const players: User[] = [
      { id: "user456", username: "player1" },
      { id: "user789", username: "player2" },
    ];
  ...
  it("should handle empty seats correctly", async () => {
    const currentUser: User = {
      id: "user123",
      username: "testuser",
    };

    const players: (User | null)[] = [currentUser, null];
