...
import {
  ...
  TestTimeoutService,
  TimeoutService,
} from "./time-control/timeout";

const LOCAL_ORIGIN = "http://127.0.0.1:5173";

// source: https://stackoverflow.com/questions/50940640/how-to-determine-if-jest-is-running-the-code-or-not
...
export function getTimeoutService(): ITimeoutService {
  // TODO: I think this is not the "correct" way to mock the timeout service
  // but I wasn't able to make it work differently :-(
